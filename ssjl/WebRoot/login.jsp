...
<HTML xmlns="http://www.w3.org/1999/xhtml">
  ...
  <BODY>
      <DIV style="MARGIN: 0px auto; WIDTH: 936px;margin-top: 100px;margin-bottom:100px; font-family: 微软雅黑;font-size: 33px;">
                          巢湖学院师生在线交流平台
      </DIV>
      ...
      <DIV style="BACKGROUND-COLOR: #278296;margin-top: 20px;">
	      <DIV style="MARGIN: 0px auto; WIDTH: 936px">
		      <DIV style="BACKGROUND: url(<%=path %>/images/chxy.jpg) no-repeat; HEIGHT: 260px">
      ...
      <br><br>
      Copyright © 2018 Dissertation &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=path %>" ;style="font-size: large; ">首页</a>
